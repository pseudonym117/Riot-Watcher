...
class ChampionMasteryApiV3Urls(object):
    by_summoner = ChampionMasteryEndpoint('/champion-masteries/by-summoner/{summoner_id}')
    by_summoner_by_champion = ChampionMasteryEndpoint('/champion-masteries/by-summoner/{summoner_id}/by-champion/{champion_id}')
