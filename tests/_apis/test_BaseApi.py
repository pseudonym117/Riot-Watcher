...
class BaseApiTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._request_handler_mock.preview_static_request = MagicMock(
            name="preview_static_request"
        )
        self._request_handler_mock.preview_static_request.return_value = (
            self._expected_preview_return
        )
        self._request_handler_mock.after_static_request = MagicMock(
        ...
        self._request_handler_mock_no_return.preview_request = MagicMock(
            name="preview_request"
        )
        self._request_handler_mock_no_return.after_request = MagicMock(
            name="after_request"
        )
        self._request_handler_mock_no_return.preview_static_request = MagicMock(
            name="preview_static_request"
        )
        self._request_handler_mock_no_return.after_static_request = MagicMock(
            name="after_static_request"
        )
    ...
    @mock.patch("requests.get")
    def test_base_api_request_version_after_handler_with_preview_no_return(
        self, mock_get
    ):
        mock_get.return_value = self._mock_api_response
