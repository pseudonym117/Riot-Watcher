...
class TestClashApiV1:
    def test_by_summoner_id(self):
        ...
        ret = clash.by_summoner_id(region, summoner_id)

        mock_base_api.raw_request.assert_called_once_with(
            ClashApiV1.__name__,
            clash.by_summoner_id.__name__,
            region,
    ...
    def test_by_team_id(self):
        ...
        ret = clash.by_team_id(region, team_id)

        mock_base_api.raw_request.assert_called_once_with(
            ClashApiV1.__name__,
            clash.by_team_id.__name__,
            region,
    ...
    def test_tournament_by_team_id(self):
        mock_base_api = MagicMock()
        expected_return = object()
        mock_base_api.raw_request.return_value = expected_return
        ...
        ret = clash.tournament_by_team_id(region, team_id)

        mock_base_api.raw_request.assert_called_once_with(
            ClashApiV1.__name__,
            clash.tournament_by_team_id.__name__,
            region,
    ...
    def test_by_tournament_id(self):
        mock_base_api = MagicMock()
        expected_return = object()
        mock_base_api.raw_request.return_value = expected_return
        ...
        ret = clash.by_tournament_id(region, tournament_id)

        mock_base_api.raw_request.assert_called_once_with(
            ClashApiV1.__name__,
            clash.by_tournament_id.__name__,
            region,
